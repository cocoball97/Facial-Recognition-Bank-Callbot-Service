...
import sys
sys.path.insert(0, 'C:/Users/Administrator/Desktop/faceid/Silent-Face-Anti-Spoofing')
...
class CamApp(App):
    ...
    def verify(self, *args):
        ...
        if len(faces) > 0:
            ...
            label = test(
                image=frame,
                model_dir='C:/Users/Administrator/Desktop/faceid/Silent-Face-Anti-Spoofing/resources/anti_spoof_models',
                device_id=0
                )
            ...
            if label == 1:
                ...
                if verified:
                    # Load customer_db
                    customer_db = pd.read_csv('C:/Users/Administrator/Desktop/faceid/app/customer_db.csv')
